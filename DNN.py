...
model.add(Dense(13, input_dim=num_of_features, kernel_initializer = HeNormal(), activation="relu"))
model.add(Dense(num_of_classes, input_dim=14, kernel_initializer = HeNormal()))
